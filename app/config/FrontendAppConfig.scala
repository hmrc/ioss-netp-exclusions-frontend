...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  private val contactFormServiceIdentifier = "ioss-netp-exclusions-frontend"
  ...
  val exitSurveyUrl: String             = s"$exitSurveyBaseUrl/feedback/ioss-netp-exclusions-frontend"
